...
const UserLogin =()=>{
    return(
        ...
        <div className='ui card' style={{ padding: '15px', width: '97%', boxShadow: '1px 1px 4px 2px #DEDEDE', backgroundColor: 'rgb(135 20 91)', borderRadius: '10px' }}>
          <Form>
            <Form.Field>
              <input type={'text'} style={{ padding: '15px', borderRadius: '7px', fontSize: '18px' }} placeholder='USER LOGIN ID' required />
            </Form.Field>
            ...
            <Form.Field style={{ textAlign: "center", marginTop: '18px' }}>
              ...
              <Link to='/home'>
              <Button style={{ width: '100%', borderRadius: '7px', fontSize: '18px', padding: '15px'}} className='ui primary button'><span style={{ fontSize: '20px'}}>Login as User</span></Button>
              </Link>
